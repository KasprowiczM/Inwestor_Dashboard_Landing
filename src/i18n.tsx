...
const dictionary: Dictionary = {
  ...
  'plans.investor.f2': { pl: '1487-dniowy golden freeze i replay manifest', en: '1487-day golden freeze & replay manifest' },
  'plans.investor.f3': { pl: 'Wieloryby, ETF i log zdarzeń', en: 'Whales, ETF and event log' },
  'plans.investor.f4': { pl: 'Planer DCA, alerty z DeliveryReceipt i ledger SQL', en: 'DCA planner, DeliveryReceipt alerts & SQL ledger' },

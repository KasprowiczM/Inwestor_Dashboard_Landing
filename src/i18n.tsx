...
const dictionary: Dictionary = {
  ...
  'hero.title.b': { pl: 'Jak wytrawni inwestorzy.', en: 'Like seasoned investors.' },
  'hero.copy': {
  ...
  'faq.update.a': { pl: 'Dashboard korzysta z cache i harmonogramów odświeżania, żeby nie przeciążać API. Landing pokazuje tylko bezpieczny publiczny snapshot.', en: 'The dashboard uses cache and refresh schedules to avoid overloading the API. The landing shows only a safe public snapshot.' },

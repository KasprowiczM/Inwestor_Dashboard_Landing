...
const dictionary: Dictionary = {
  ...
  'hero.title.b': { pl: 'Zanim zrobi to tłum.', en: 'Before the crowd.' },
  'hero.copy': {
  ...
  'live.eyebrow': { pl: 'Publiczny teaser', en: 'Public teaser' },
  'live.title': { pl: 'Bottom Score', en: 'Bottom Score' },
  'live.loading': { pl: 'Ładowanie snapshotu', en: 'Loading snapshot' },
  'live.unavailable': { pl: 'Snapshot jest obecnie chroniony', en: 'Snapshot is currently protected' },
  'live.note': {
    pl: 'Po udostępnieniu publicznego, zredagowanego endpointu panel pokaże aktualny score bez ujawniania metodologii.',
    en: 'Once a public redacted endpoint is exposed, this panel will show the current score without revealing methodology.',
  },
  ...
  'plans.smart.f4': { pl: 'Rodziny sygnałów i liczba źródeł', en: 'Signal families and source count' },
  ...
  'trust.sources': { pl: 'Źródła danych', en: 'Data sources' },
  ...
  'faq.data.a': { pl: 'Model korzysta z publicznych i licencjonowanych źródeł rynkowych, sentymentu, makro i on-chain. Publiczny landing nie pokazuje chronionych detali.', en: 'The model uses public and licensed market, sentiment, macro and on-chain sources. The public landing does not expose protected detail.' },
  'faq.update.q': { pl: 'Jak często odświeżane są dane?', en: 'How often is data refreshed?' },
  'faq.update.a': { pl: 'Dashboard korzysta z cache i harmonogramów odświeżania, żeby nie przeciążać źródeł ani API. Landing pokazuje tylko bezpieczny publiczny snapshot.', en: 'The dashboard uses cache and refresh schedules to avoid overloading sources or APIs. The landing shows only a safe public snapshot.' },
